...
<input type="radio" name="job" value="Staff"></td>
	  
 <td>Student</td><td style="width:30px;">
<input type="radio" name="job" value="Student"></td>
...
<td><input type="email" placeholder="youremail@hostname"name="mailid"/></td>
